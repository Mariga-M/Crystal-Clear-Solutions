...
const Contact: React.FC = () => {
  ...
  const handleSendViaWhatsApp = () => {
    const message = `Hi! I'd like to request a quote for cleaning services.
...
Please provide me with a detailed quote. Thank you!`;
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone',
      details: '+254713380803',
      subtitle: 'Call us anytime'
    },
    {
      icon: Mail,
      title: 'Email',
      details: 'caroline.mariga77@gmail.com',
  ...
  return (
    ...
    <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="Send Quote Request">
