...
const LiveChat: React.FC = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      let botResponse = "Thank you for your message! For immediate assistance, please call us at +254713380803 or use our contact form. We'll get back to you within 2 hours.";
